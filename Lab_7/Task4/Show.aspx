<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Lb8_Task4.Show" %>
...
<body>
 ...
 <h2>All Data</h2>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:studentConnectionString %>" DeleteCommand="DELETE FROM [student] WHERE [sid] = @sid" InsertCommand="INSERT INTO [student] ([name]) VALUES (@name)" SelectCommand="SELECT [sid], [name] FROM [student]" UpdateCommand="UPDATE [student] SET [name] = @name WHERE [sid] = @sid">
                <DeleteParameters>
        ...
        &nbsp;<div id="ShowDetails" runat="server">
            ...
            <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Lb8_Task4.studentDataContext" EntityTypeName="" TableName="student" Where="sid == @sid">
                <WhereParameters>
